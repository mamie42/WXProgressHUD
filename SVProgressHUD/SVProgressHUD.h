...
typedef NS_ENUM(NSInteger,SVProgressHUDPosition){
    SVProgressHUDPositionCenter,
    SVProgressHUDPositionBoutton
};
...
@property (assign, nonatomic) SVProgressHUDPosition defaultPosition;
